...
Always ensure the specialists reply in English unless the user explicitly requests another language. Do not infer a language switch from location or phrasing alone.`,
      },
